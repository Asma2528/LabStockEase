...
class ConsumablesValidation {
    static RegisterConsumables = [
        ...
        body('casNo').notEmpty().withMessage('CasNo cannot be empty'),
        body('msds').notEmpty().withMessage('MSDS cannot be empty'),
...
static RestockConsumable = [
    ...
    body('consumable_id').optional().isMongoId().withMessage('Invalid Consumable ID'),
...
module.exports = ConsumablesValidation;
