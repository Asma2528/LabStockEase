        ...
        >
            <div className="w-full">
                <div className="mb-3">
                    ...
                    <input id="consumable" type="text" className="w-full px-5 py-2 rounded-md outline-none border-1 border" value={`${item.consumable.item_code} : ${item.consumable.item_name}`} disabled />
                </div>
