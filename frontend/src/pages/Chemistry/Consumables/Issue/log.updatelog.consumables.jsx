...
import { useUpdateLogMutation } from '../../../../provider/queries/Consumables.query'; 
...
const UpdateModel = ({ visible, setVisible, log }) => {
    ...
    const [updateConsumablesLog] = useUpdateLogMutation(); 
    ...
    const onSubmitHandler = async (values) => {
        try {
            ...
            const response = await updateConsumablesLog({
