...
import { useLogIssuedQuantityMutation, useGetAllConsumablesItemsQuery } from "../../../../provider/queries/Consumables.query";
...
const Model = ({ visible, setVisible }) => {
  const { data: consumablesData, isLoading: isConsumablesLoading } = useGetAllConsumablesItemsQuery({ query: '' });
  ...
  const handleItemCodeChange = (e, setFieldValue) => {
    const selectedItem = consumablesData?.items?.find(item => item.item_code === e.target.value);
    if (selectedItem) {
...
/>
            ...
            <div className="mb-3">
              ...
              >
                ...
                {isConsumablesLoading ? (
                  ...
                  consumablesData?.items?.map((item) => ( 
            ...
            <Button
              ...
              disabled={isLoading || isConsumablesLoading}
            >
