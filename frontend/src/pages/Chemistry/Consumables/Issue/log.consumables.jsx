...
import ConsumablesLogCard from './log.card.consumables';
import { useGetConsumablesLogsQuery } from '../../../../provider/queries/Consumables.query';

const ConsumablesLogsPage = () => {
    ...
    const { data: logs, isLoading, isFetching, refetch } = useGetConsumablesLogsQuery(searchParams);
    ...
    return (
        <>
            <div className="w-full flex flex-wrap justify-evenly mt-10">
                <BreadCrumbs PageLink='/Consumables' PageName='Consumable Log' />
                        ...
                        <table className="w-full text-sm text-left text-gray-500">
                            ...
                            <tbody>
                                {isLoading || isFetching ? (
                                    ...
                                    logs.map(log => (
                                        <ConsumablesLogCard key={log._id} data={log} />
                                    ))
                                ) : (
                                    <tr>
...
export default ConsumablesLogsPage;
