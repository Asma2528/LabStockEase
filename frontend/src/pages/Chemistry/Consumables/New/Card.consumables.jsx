...
import ViewItem from './display.consumables';
import UpdateModel from './UpdateModel.consumables';

const ConsumablesCard = ({ data, onDelete }) => {
    ...
    return (
        <>
            <tr className="bg-white border-b hover:bg-gray-50 text-gray-900 whitespace-nowrap">
                ...
                <td className="px-4 py-2">{data.casNo}</td>
