...
import GlasswaresLogCard from './log.card.glasswares';
import { useGetGlasswaresLogsQuery } from '../../../../provider/queries/Glasswares.query';
import ReportButton from './ReportButton';

const GlasswaresLogsPage = () => {
    ...
    const { data: logs, isLoading, isFetching, refetch } = useGetGlasswaresLogsQuery(searchParams);
    ...
    return (
        <>
            <div className="w-full flex flex-wrap justify-evenly mt-10">
                <BreadCrumbs PageLink='/Glasswares' PageName='Glassware Log' />
                        ...
                        <table className="w-full text-sm text-left text-gray-500">
                            ...
                            <tbody>
                                {isLoading || isFetching ? (
                                    ...
                                    logs.map(log => (
                                        <GlasswaresLogCard key={log._id} data={log}  />
                                    ))
                                ) : (
                                    <tr>
...
export default GlasswaresLogsPage;
