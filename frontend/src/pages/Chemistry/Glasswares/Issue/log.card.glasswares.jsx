...
const GlasswaresLogCard = ({ data}) => {
  ...
  {data.request || "Unknown Request"}
                ...
                <td className="px-4 py-2 font-medium">
                    {data.item?.item_code || "Unknown Item"} - {data.item?.item_name || "Unknown Item"}
                </td>
                ...
                <td className="px-4 py-2">{data.user_email}</td>
                                <td className="px-4 py-2">{data.returned_quantity}</td>

                <td className="px-4 py-2">{data.lost_or_damaged_quantity}</td>
                                <td className="px-4 py-2">{formatDate(data.date_issued)}</td>
...
export default GlasswaresLogCard;
