...
import Model from './model.glasswares';
import { GoPlus } from "react-icons/go";
import { useGetAllGlasswaresItemsQuery } from '../../../../provider/queries/Glasswares.query';
import Loader from '../../../../components/Loader';
import GlasswaresCard from './Card.glasswares';
import { useNavigate } from 'react-router-dom';
import { confirmDialog, ConfirmDialog } from 'primereact/confirmdialog';
import { toast } from 'sonner';
import { Button } from 'primereact/button';
import { useDeleteGlasswaresItemMutation } from '../../../../provider/queries/Glasswares.query';
import ReportButton from './ReportButton';

const GlasswaresPage = () => {
    ...
    const { isLoading, data, refetch } = useGetAllGlasswaresItemsQuery(searchParams);
    ...
    const [DeleteGlasswaresItem] = useDeleteGlasswaresItemMutation();
                ...
                <div className="p-dialog-footer">
                    <Button
                        ...
                        onClick={async () => {
                            ...
                            try {
                                const { data, error } = await DeleteGlasswaresItem(_id);
                                if (error) {
    ...
    return (
        <div className="w-full flex flex-wrap justify-evenly mt-10">
            <BreadCrumbs PageLink='/Glasswares' PageName='Glassware' />
            ...
            <div className="mb-3 flex justify-end w-[85%] mx-auto gap-x-6">
                ...
                >
                    Register New Glassware <GoPlus />
                </button>

                <button
                    onClick={() => navigate('/chemistry/glasswares/restock')}
                ...
                <button
                    onClick={() => navigate('/chemistry/glasswares/logs')}
