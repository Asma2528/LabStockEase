...
import RestockModel from "./restock.models.glasswares";
import { GoPlus } from "react-icons/go";
import {
  useGetAllRestockItemsQuery,
  useDeleteRestockItemMutation,
} from "../../../../provider/queries/Glasswares.query";
import RestockCard from "./restock.card.glasswares";
import { confirmDialog, ConfirmDialog } from "primereact/confirmdialog";
import { toast } from "sonner";
import { Button } from "primereact/button";

const GlasswaresRestockPage = () => {
  ...
  return (
    <>
      <div className="w-full flex flex-wrap justify-evenly mt-10">
        ...
        <input 
                        name="createdAt" 
                        placeholder="Search using Created At Date" 
                        type="text"   
          ...
          <div className="relative overflow-x-auto shadow">
            <table className="w-full text-sm text-left text-gray-500">
              <thead className="text-xs text-gray-700 border-b uppercase bg-gray-50">
                <tr>
                  <th className="px-4 py-2">Glassware</th>
...
export default GlasswaresRestockPage;
