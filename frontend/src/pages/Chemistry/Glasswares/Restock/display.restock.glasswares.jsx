        ...
        >
            <div className="w-full">
                <div className="mb-3">
                    ...
                    <input id="glassware" type="text" className="w-full px-5 py-2 rounded-md outline-none border-1 border" value={`${item.glassware.item_code} : ${item.glassware.item_name}`} disabled />
                </div>
