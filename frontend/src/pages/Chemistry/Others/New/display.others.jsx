...
const ViewItem = ({ visible, setVisible, item }) => {
    ...
    return (
      ...
      <div className="mb-3">
                            ...
                            <input name="category" id="category" type="text" value={item.category} className="w-full px-5 py-2 rounded-md outline-none border-1 border" placeholder="Enter Category" />
                        </div>  
