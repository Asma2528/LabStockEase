...
import OthersLogCard from './log.card.others';
import { useGetOthersLogsQuery } from '../../../../provider/queries/Others.query';

const OthersLogsPage = () => {
    ...
    const { data: logs, isLoading, isFetching, refetch } = useGetOthersLogsQuery(searchParams);
    ...
    return (
        <>
            <div className="w-full flex flex-wrap justify-evenly mt-10">
                <BreadCrumbs PageLink='/Others' PageName='Other Log' />
                        ...
                        <table className="w-full text-sm text-left text-gray-500">
                            ...
                            <tbody>
                                {isLoading || isFetching ? (
                                    ...
                                    logs.map(log => (
                                        <OthersLogCard key={log._id} data={log} />
                                    ))
                                ) : (
                                    <tr>
