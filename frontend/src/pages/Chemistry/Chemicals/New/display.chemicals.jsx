...
const ViewItem = ({ visible, setVisible, item }) => {
    ...
    return (
      ...
      <div className="mb-3">
                            ...
                            <input name="casNo" id="casNo" type="text" value={item.casNo} className="w-full px-5 py-2 rounded-md outline-none border-1 border" placeholder="Enter CAS No" />
                        </div>  

                        <div className="mb-3">
                            <label htmlFor="msds">MSDS Link <span className="text-red-500 text-sm">*</span></label>
                            <input name="msds" id="msds" type="text" value={item.msds}className="w-full px-5 py-2 rounded-md outline-none border-1 border" placeholder="Enter MSDS Link" />
                        </div>
