...
import ViewItem from './display.equipments';
import UpdateModel from './UpdateModel.equipments';

const EquipmentsCard = ({ data, onDelete }) => {
    ...
    return (
        <>
            <tr className="bg-white border-b hover:bg-gray-50 text-gray-900 whitespace-nowrap">
                ...
                <td className="px-4 py-2">{data.serial_number}</td>
