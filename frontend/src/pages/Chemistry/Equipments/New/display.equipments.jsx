...
const ViewItem = ({ visible, setVisible, item }) => {
    ...
    return (
      ...
      <div className="mb-3">
                            ...
                            <input name="serial_number" id="serial_number"  type="text" value={item.serial_number} className="w-full px-5 py-2 rounded-md outline-none border-1 border" placeholder="Enter Serial Number" />
                        </div>  

                        <div className="mb-3">
                            <label htmlFor="model_number">Model Number<span className="text-red-500 text-sm">*</span></label>
                            <input name="model_number" id="model_number" type="text" value={item.model_number} className="w-full px-5 py-2 rounded-md outline-none border-1 border" placeholder="Enter Model Number" />
                            </div>  

                        <div className="mb-3">
                            <label htmlFor="">Manual Link <span className="text-red-500 text-sm">*</span></label>
                            <input name="manual" id="manual" type="text" value={item.manual}className="w-full px-5 py-2 rounded-md outline-none border-1 border" placeholder="Enter Manual Link" />
                        </div>
