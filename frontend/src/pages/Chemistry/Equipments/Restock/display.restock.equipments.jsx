        ...
        >
            <div className="w-full">
                <div className="mb-3">
                    ...
                    <input id="equipment" type="text" className="w-full px-5 py-2 rounded-md outline-none border-1 border" value={`${item.equipment.item_code} : ${item.equipment.item_name}`} disabled />
                </div>
             ...
             <div className="mb-3">
                ...
                <div className="mb-3">
                    ...
                    <input id="maintenance_date" type="text" className="w-full px-5 py-2 rounded-md outline-none border-1 border" value={formatDate(item.maintenance_date) || 'N/A'} disabled />
                </div>

                <div className="mb-3">
                    <label htmlFor="maintenance_details">Maintenance Details</label>
                    <input id="maintenance_details" type="text" className="w-full px-5 py-2 rounded-md outline-none border-1 border" value={item.maintenance_details|| 'N/A'} disabled />
                </div>
