...
import { useUpdateLogMutation } from '../../../../provider/queries/Equipments.query'; 
...
console.log(log);
    ...
    const [updateEquipmentsLog] = useUpdateLogMutation(); 
    ...
    const onSubmitHandler = async (values) => {
        try {
            ...
            const response = await updateEquipmentsLog({
