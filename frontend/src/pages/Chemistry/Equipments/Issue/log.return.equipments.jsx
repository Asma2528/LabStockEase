...
import { useReturnLogMutation } from "../../../../provider/queries/Equipments.query";
...
const ReturnModel = ({ visible, setVisible ,log}) => {
  ...
  const [returnEquipmentsLog] = useReturnLogMutation(); 
  ...
  const onSubmitHandler = async (values) => {
    try {
        ...
        const response = await returnEquipmentsLog({
