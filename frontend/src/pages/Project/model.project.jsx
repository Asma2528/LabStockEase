...
import { useAddProjectMutation } from '../../provider/queries/Projects.query';


const ProjectModel = ({ visible, setVisible }) => {
    ...
    const onSubmitHandler = async (values, { resetForm }) => {
        try {
            ...
            if (response.error) {
                toast.error(response.error.data.message || 'Failed to add project');
                return;
            }
