...
const ViewReturnedRequisitionPage = () => {
  ...
  useGetReturnRequisitionsQuery(searchParams);
  ...
  return (
    <div className="w-full flex flex-wrap justify-evenly mt-10">
      <BreadCrumbs
        PageLink="/view-return-requisition"
        PageName="View Returned Requisitions"
      />
                  ...
                  <tr key={requisition._id}>
                    ...
                    <td className="px-4 py-2 flex gap-x-2">
                      <Button
                        ...
                        className={`p-3 bg-indigo-600 text-white rounded-sm mx-2`}
                        title="View"
                      >
      ...
      {isDialogVisible && selectedRequisition && (
        <div className="fixed inset-0 z-50 flex justify-center items-center bg-gray-500 bg-opacity-50">
          <div className="bg-white p-8 rounded-md w-full max-w-6xl h-[80vh] overflow-y-auto relative">
            <h2 className="text-xl font-semibold mb-4">View Returned Requisition</h2>
            {/* Close Button */}
            <button
              ...
              <div className="mb-3">
                ...
                <div className="mb-3">
                  ...
                  <select
                    ...
                    value={selectedRequisition.status} 
...
export default ViewReturnedRequisitionPage;
