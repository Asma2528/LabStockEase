...
import { useCreateRequisitionMutation } from '../../provider/queries/Requisition.query';
  ...
  const onSubmitHandler = async (values, { resetForm }) => {
    try {
      ...
      const requisitionData = {
        ...
        date_of_requirement: values.date_of_requirement,
      ...
      const response = await createRequisition(requisitionData);
