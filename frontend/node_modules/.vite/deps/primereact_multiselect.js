...
import {
  ...
  SearchIcon,
  VirtualScroller
} from "./chunk-6EGYHGSI.js";
import {
  OverlayService
} from "./chunk-3VRDBNZP.js";
import {
  SpinnerIcon,
  Tooltip
} from "./chunk-33RM3FRA.js";
import {
  CSSTransition,
  TimesIcon
} from "./chunk-ZAIUBXSF.js";
import "./chunk-IEDFSBTU.js";
import "./chunk-W6HCFRFS.js";
import "./chunk-DQ2AMLMA.js";
import "./chunk-CTLOAQU5.js";
import {
  IconBase,
  Portal,
  Ripple
} from "./chunk-REBIP2XP.js";
...
import {
  ...
  classNames,
  localeOption
} from "./chunk-YIQEIH42.js";
import "./chunk-LJJROCM4.js";
import {
  require_react
...
var InputText = React2.memo(React2.forwardRef(function(inProps, ref) {
  ...
  var isFilled = React2.useMemo(function() {
  ...
  return React2.createElement(React2.Fragment, null, React2.createElement("input", _extends2({
    ref: elementRef
  }, rootProps)), hasTooltip && React2.createElement(Tooltip, _extends2({
    target: elementRef,
...
var Checkbox = React3.memo(React3.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  ...
  var createBoxElement = function createBoxElement2() {
    ...
    var icon = checked ? props.icon || React3.createElement(CheckIcon, iconProps) : null;
    var checkboxIcon = IconUtils.getJSXIcon(icon, _objectSpread$4({}, iconProps), {
      props,
      checked
    });
    return React3.createElement("div", boxProps, checkboxIcon);
  };
  return React3.createElement(React3.Fragment, null, React3.createElement("div", _extends3({
    ref: elementRef
  }, rootProps), createInputElement(), createBoxElement()), hasTooltip && React3.createElement(Tooltip, _extends3({
    target: elementRef,
    content: props.tooltip,
    pt: ptm("tooltip")
  }, props.tooltipOptions)));
...
var MultiSelectHeader = React3.memo(function(props) {
  var mergeProps = useMergeProps();
  ...
  var createFilterElement = function createFilterElement2() {
    ...
    var icon2 = props.filterIcon || React3.createElement(SearchIcon, filterIconProps);
    ...
    if (props.filter) {
      ...
      var content = React3.createElement("div", filterContainerProps, React3.createElement(InputText, {
        ref: props.filterRef,
        type: "text",
        role: "searchbox",
  ...
  var checkedIcon = props.itemCheckboxIcon || React3.createElement(CheckIcon, headerCheckboxIconProps);
  var itemCheckboxIcon = IconUtils.getJSXIcon(checkedIcon, _objectSpread$3({}, headerCheckboxIconProps), {
    selected: props.selected
  });
  var checkboxElement = props.showSelectAll && React3.createElement("div", headerCheckboxContainerProps, React3.createElement(Checkbox, {
    id: selectAllId,
    checked: props.selectAll,
    ...
    unstyled: isUnstyled()
  }), !props.filter && React3.createElement("label", headerSelectAllLabelProps, props.selectAllLabel));
  var iconProps = mergeProps({
    className: cx("closeIcon"),
    "aria-hidden": true
  }, getPTOptions("closeIcon"));
  var icon = props.closeIcon || React3.createElement(TimesIcon, iconProps);
  ...
  var element = React3.createElement("div", headerProps, checkboxElement, filterElement, closeElement);
  if (props.template) {
    var defaultOptions = {
...
var MultiSelectItem = React3.memo(function(props) {
  var _React$useState = React3.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), focusedState = _React$useState2[0], setFocusedState = _React$useState2[1];
  var checkboxRef = React3.useRef(null);
  var mergeProps = useMergeProps();
  var ptm = props.ptm, cx = props.cx, isUnstyled = props.isUnstyled;
  ...
  var icon = props.checkboxIcon || React3.createElement(CheckIcon, checkboxIconProps);
  ...
  return React3.createElement("li", itemProps, React3.createElement("div", checkboxContainerProps, React3.createElement(Checkbox, {
    ref: checkboxRef,
    checked: props.selected,
    icon: checkboxIcon,
    pt: ptm("checkbox"),
    unstyled: isUnstyled()
  })), React3.createElement("span", null, content), React3.createElement(Ripple, null));
});
...
var MultiSelectPanel = React3.memo(React3.forwardRef(function(props, ref) {
  ...
  var createHeader = function createHeader2() {
    return React3.createElement(MultiSelectHeader, {
      hostName: props.hostName,
      id: props.id,
      filter: props.filter,
  ...
  var createGroupChildren = function createGroupChildren2(optionGroup, style) {
    ...
    return groupChildren.map(function(option, j) {
      ...
      return React3.createElement(MultiSelectItem, {
        hostName: props.hostName,
        index: j,
        key: optionKey,
  ...
  var createEmptyFilter = function createEmptyFilter2() {
    ...
    return React3.createElement("li", emptyMessageProps, emptyFilterMessage);
  };
  var createEmptyContent = function createEmptyContent2() {
    ...
    return React3.createElement("li", emptyMessageProps, emptyMessage);
  };
  var createItem = function createItem2(option, index) {
    ...
    if (props.optionGroupLabel) {
      ...
      return React3.createElement(React3.Fragment, {
        key
      }, React3.createElement("li", itemGroupProps, groupContent), groupChildrenContent);
    }
    var optionLabel = props.getOptionLabel(option);
  ...
  var createElement4 = function createElement5() {
    ...
    return React3.createElement(CSSTransition, _extends3({
      ...
      ref
    }, panelProps), React3.createElement("span", firstHiddenElementProps), header, content, footer, React3.createElement("span", lastHiddenElementProps)));
  };
...
var MultiSelect = React3.memo(React3.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  var context = React3.useContext(PrimeReactContext);
  var props = MultiSelectBase.getProps(inProps, context);
  var _React$useState = React3.useState(null), _React$useState2 = _slicedToArray(_React$useState, 2), focusedOptionIndex = _React$useState2[0], setFocusedOptionIndex = _React$useState2[1];
  var _React$useState3 = React3.useState(false), _React$useState4 = _slicedToArray(_React$useState3, 2), clicked = _React$useState4[0], setClicked = _React$useState4[1];
  var _React$useState5 = React3.useState(""), _React$useState6 = _slicedToArray(_React$useState5, 2), filterState = _React$useState6[0], setFilterState = _React$useState6[1];
  var _React$useState7 = React3.useState(-1), _React$useState8 = _slicedToArray(_React$useState7, 2), startRangeIndex = _React$useState8[0], setStartRangeIndex = _React$useState8[1];
  var _React$useState9 = React3.useState(false), _React$useState10 = _slicedToArray(_React$useState9, 2), focusedState = _React$useState10[0], setFocusedState = _React$useState10[1];
  var _React$useState11 = React3.useState(props.inline), _React$useState12 = _slicedToArray(_React$useState11, 2), overlayVisibleState = _React$useState12[0], setOverlayVisibleState = _React$useState12[1];
  var elementRef = React3.useRef(null);
  ...
  var inputRef = React3.useRef(props.inputRef);
  var labelRef = React3.useRef(null);
  ...
  var onOptionSelect = function onOptionSelect2(event, option) {
    ...
    if (selected) {
      ...
      value = [].concat(_toConsumableArray2(props.value || []), [getOptionValue(option)]);
    }
      ...
      if (event.checked) {
        ...
        if (props.optionGroupLabel) {
          ...
          options.forEach(function(optionGroup) {
            return value = [].concat(_toConsumableArray2(value), _toConsumableArray2(getOptionGroupChildren(optionGroup).filter(function(option) {
  ...
  var getLabelContent = function getLabelContent2() {
    ...
    if (props.display === "chip" && !empty) {
      ...
      return value.map(function(val, i) {
        ...
        var icon = !props.disabled && (props.removeIcon ? IconUtils.getJSXIcon(props.removeIcon, _objectSpread2({}, iconProps), {
          props
        }) : React3.createElement(TimesCircleIcon, iconProps));
        ...
        return React3.createElement("div", _extends3({}, tokenProps, {
          key: labelKey
        }), React3.createElement("span", tokenLabelProps, label3), icon);
      });
    }
    return getLabel();
  };
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done; ) {
            ...
            if (filteredSubOptions && filteredSubOptions.length) {
              filteredGroups.push(_objectSpread2(_objectSpread2({}, optgroup), _defineProperty2({}, props.optionGroupChildren, filteredSubOptions)));
            }
          }
        } catch (err) {
          _iterator3.e(err);
  ...
  var createClearIcon = function createClearIcon2() {
    ...
    var clearIcon2 = IconUtils.getJSXIcon(icon, _objectSpread2({}, clearIconProps), {
      props
    });
  ...
  var createLabel = function createLabel2() {
    ...
    return React3.createElement("div", labelContainerProps, React3.createElement("div", labelProps, content || props.placeholder || props.emptyMessage || "empty"));
  };
  ...
  var loadingIcon = props.loadingIcon ? IconUtils.getJSXIcon(props.loadingIcon, _objectSpread2({}, triggerIconProps), {
    props
  }) : React3.createElement(SpinnerIcon, _extends3({
    spin: true
  }, triggerIconProps));
  var dropdownIcon = props.dropdownIcon ? IconUtils.getJSXIcon(props.dropdownIcon, _objectSpread2({}, triggerIconProps), {
    props
  }) : React3.createElement(ChevronDownIcon, triggerIconProps);
  var triggerIcon = React3.createElement("div", triggerProps, props.loading ? loadingIcon : dropdownIcon);
  var label2 = !props.inline && createLabel();
  var clearIcon = !props.inline && createClearIcon();
  var rootProps = mergeProps(_objectSpread2(_objectSpread2({
    ref: elementRef,
    id: props.id,
    style: _objectSpread2(_objectSpread2({}, props.style), sx("root")),
    className: classNames(props.className, cx("root", {
      focusedState,
      context,
      overlayVisibleState
  ...
  return React3.createElement(React3.Fragment, null, React3.createElement("div", rootProps, React3.createElement("div", hiddenInputWrapperProps, React3.createElement("input", _extends3({}, inputProps, {
    readOnly: true
  }))), !props.inline && React3.createElement(React3.Fragment, null, label2, clearIcon, triggerIcon), React3.createElement(MultiSelectPanel, _extends3({
