...
var Dropdown = React.memo(React.forwardRef(function(inProps, ref) {
  ...
  var createLabel = function createLabel2() {
    ...
    var content = props.valueTemplate ? ObjectUtils.getJSXElement(props.valueTemplate, selectedOption, props) : label || props.placeholder || props.emptyMessage || React.createElement(React.Fragment, null, " ");
