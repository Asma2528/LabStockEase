...
var VirtualScroller = React3.memo(React3.forwardRef(function(inProps, ref) {
  ...
  var _React$useState5 = React3.useState(0), _React$useState6 = _slicedToArray(_React$useState5, 2), pageState = _React$useState6[0], setPageState = _React$useState6[1];
  ...
  var _React$useState9 = React3.useState(props.numToleratedItems), _React$useState10 = _slicedToArray(_React$useState9, 2), numToleratedItemsState = _React$useState10[0], setNumToleratedItemsState = _React$useState10[1];
  var _React$useState11 = React3.useState(props.loading || false), _React$useState12 = _slicedToArray(_React$useState11, 2), loadingState = _React$useState12[0], setLoadingState = _React$useState12[1];
  var _React$useState13 = React3.useState([]), _React$useState14 = _slicedToArray(_React$useState13, 2), loaderArrState = _React$useState14[0], setLoaderArrState = _React$useState14[1];
  ...
  var createLoader = function createLoader2() {
    ...
    if (!props.loaderDisabled && props.showLoader && loadingState) {
      ...
      return React3.createElement("div", loaderProps, _content);
    }
    return null;
  };
  ...
  if (props.disabled) {
    ...
    return React3.createElement(React3.Fragment, null, props.children, _content2);
  }
  ...
  return React3.createElement("div", rootProps, content, spacer, loader);
}));
...
var CheckIcon = React4.memo(React4.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
//# sourceMappingURL=chunk-6EGYHGSI.js.map
